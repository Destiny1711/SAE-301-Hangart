...
<body>
  ...
  <div class="info2">
    ...
    <div class="line"></div>
    <p class="info_description">Bienvenue dans l'interface administrateur, vous pourrez trouver ici l'accès aux différentes informations dont la modification vous est autorisée.</p>
  </div>
  <ul class="div_btnp">
    <?php
      echo'
